...
- Handler registration for prep/issue/cleanup phases
- Operation validation and support checking 
- Operation-specific flag and requirement specifications
- Initialization of operation tables at boot
- Registration of operation metadata and names
## openclose.c
## poll.c
## register.c
## rsrc.c
